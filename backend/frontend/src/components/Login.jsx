...
<form onSubmit={handleSubmit(onSubmit)}  className='border border-white rounded-md px-6 py-3 space-y-3 w-96'>
<h1 className='text-2xl text-center'>Chat <span className='text-green-500 font-semibold space-y-3'>App</span></h1>
...
<p>Have an account ? <Link to="/signup" className='text-blue-500 underline cursor-pointer ml-1'>Signup</Link></p>
